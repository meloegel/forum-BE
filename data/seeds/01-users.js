...
exports.seed = function (knex, Promise) {
  return knex('users').insert([
    ...
    { id: 2, username: 'Bob', password: 'asdasd', location: 'Detroit, MI', email: 'email@email.com', avatar: 'https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.macrumors.com%2F2017%2F11%2F03%2Fface-with-tears-of-joy-most-popular-emoji%2F&psig=AOvVaw0mhJkgmNP6Zra8QSEFL-TE&ust=1608072375909000&source=images&cd=vfe&ved=0CAIQjRxqFwoTCIj-0sfGzu0CFQAAAAAdAAAAABAD', quote: 'test', about: 'test' },
